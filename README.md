...
- **2026-08** WebUI 4차: 그래프 워크스페이스(도킹·Y축 추가), USB 우선 BLE 연결, 라이트 격자·칩 배치 수정, 로그 리사이즈
- **2026-08** WebUI 3차: 축 표기 정리(기호+단위), 겹침 제거, 분석 아이콘 개선
- **2026-08** WebUI 2차: 축 클릭 변수 선택, 사각형 ROI, 성분 토글, ROI 우클릭/피팅 버그 수정
- **2026-08** WebUI 대규모 개선: 별명 연결, 차트-수집 연동, XY 플롯, 분석 도구(접선·적분·피팅·ROI 내보내기)
